  ...
  return (
    <View>
      <Blueprint style={styles.cupoBox}>
        <Text style={styles.cupoTitle}>Cupo de vacaciones · Septiembre</Text>
...
const styles = StyleSheet.create({
  ...
  cupoTitle: { fontFamily: font.heading, fontSize: 11, letterSpacing: 1.8, textTransform: 'uppercase', color: color.neutral600, marginBottom: 10 },
